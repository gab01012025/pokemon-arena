...
const starterPokemon = [
  ...
  },
  {
    ...
    moves: [
      {
        name: 'Ember',
        description: 'Charmander shoots small flames that deal 20 damage to one enemy.',
        classes: JSON.stringify([CLASSES.SPECIAL, CLASSES.RANGED, CLASSES.INSTANT]),
      ...
      {
        name: 'Scratch',
        description: 'Charmander scratches with sharp claws, dealing 15 damage.',
        classes: JSON.stringify([CLASSES.PHYSICAL, CLASSES.MELEE]),
        cost: JSON.stringify({ normal: 1 }),
        damage: 15,
        effects: JSON.stringify([]),
      ...
      {
        name: 'Flamethrower',
        description: 'Charmander breathes intense flames, dealing 35 damage with 20% burn chance.',
        classes: JSON.stringify([CLASSES.SPECIAL, CLASSES.RANGED]),
      ...
      {
        name: 'Dragon Rage',
        description: 'Charmander unleashes draconic fury dealing 25 fixed damage.',
        classes: JSON.stringify([CLASSES.SPECIAL, CLASSES.RANGED]),
        cost: JSON.stringify({ fire: 1, normal: 1 }),
        cooldown: 2,
        damage: 25,
        effects: JSON.stringify([]),
        target: 'OneEnemy',
  ...
  {
    name: 'Squirtle',
    description: 'The Tiny Turtle Pokémon. When it retracts its neck into its shell, it squirts water with vigorous force.',
    ...
    moves: [
      {
        name: 'Water Gun',
        description: 'Squirtle sprays water at the target, dealing 20 damage.',
        classes: JSON.stringify([CLASSES.SPECIAL, CLASSES.RANGED, CLASSES.INSTANT]),
      ...
      {
        name: 'Tackle',
        description: 'Squirtle charges at the target, dealing 15 damage.',
        classes: JSON.stringify([CLASSES.PHYSICAL, CLASSES.MELEE]),
        cost: JSON.stringify({ normal: 1 }),
        damage: 15,
        effects: JSON.stringify([]),
      ...
      {
        name: 'Bubble Beam',
        description: 'Squirtle fires bubbles at high speed, dealing 30 damage.',
        classes: JSON.stringify([CLASSES.SPECIAL, CLASSES.RANGED]),
      ...
      {
        name: 'Withdraw',
        description: 'Squirtle retreats into its shell, reducing damage taken for 2 turns.',
        classes: JSON.stringify([CLASSES.STATUS]),
        cost: JSON.stringify({ water: 1 }),
        duration: 2,
        effects: JSON.stringify([{ type: 'defense', value: 25, target: 'self' }]),
        target: 'Self',
        slot: 3,
      },
    ],
  },
  {
    ...
    moves: [
      {
        name: 'Vine Whip',
        description: 'Bulbasaur strikes with vines, dealing 20 damage.',
        classes: JSON.stringify([CLASSES.PHYSICAL, CLASSES.MELEE, CLASSES.INSTANT]),
      ...
      {
        name: 'Poison Powder',
        description: 'Bulbasaur spreads toxic spores, poisoning one enemy for 3 turns.',
      ...
      {
        name: 'Solar Beam',
        description: 'Bulbasaur charges solar energy, then blasts 30 damage.',
        classes: JSON.stringify([CLASSES.SPECIAL, CLASSES.RANGED]),
      ...
      {
        name: 'Leech Seed',
        description: 'Bulbasaur plants seeds that drain 10 HP per turn for 3 turns.',
        classes: JSON.stringify([CLASSES.STATUS, CLASSES.AFFLICTION]),
        cost: JSON.stringify({ grass: 1 }),
        duration: 3,
