      ...
      <div className="main-container">
        ...
        <main className="center-content">
          ...
          <div className="breadcrumb">
            <Link href="/">Naruto Arena</Link> &gt; <Link href="/game-manual">Game manual</Link> &gt; <span className="current">The basics</span>
          </div>

          <div className="section-content">
            <p>This section of the game manual is a basic overview of the user interface, game play, and standard terminology within the game. Naruto-Arena is a turn based strategy game where your team of three ninjas is pitted against another player&apos;s team of three ninjas with the goal of reducing your opposition to 0 health points and winning the match.</p>
          </div>
          ...
          <div className="content-section">
            ...
            <div className="section-content">
              ...
              <p>The first thing you will see when beginning a game of Naruto-Arena is the screen below (without the big blue letters). This is the Character Selection screen and what ever is and does is explained below.</p>
              
              <ul>
                <li><strong>A:</strong> This section displays your player information. It shows your avatar, username, ninja rank, ladder rank, win-loss record, and win-loss streak, all in that order.</li>
                <li><strong>B:</strong> This section has three boxes for you to drag and drop the ninjas you wish to use in your team. Only when you have selected three ninjas may you begin a match.</li>
                ...
                <li><strong>E:</strong> By clicking on a skill icon of a character in section &apos;D&apos; this section will display the information about that skill. The upper left cut text is the name of the skill. The upper right is the chakra cost of the skill. The center is the description.</li>
